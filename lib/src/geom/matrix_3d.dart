...
class Matrix3D {
  ...
  void rotate(num vx, num vy, num vz, num angle) {

    num length = math.sqrt(vx * vx + vy * vy + vz * vz);
    num nx = vx / length;
    num ny = vy / length;
    num nz = vz / length;
    num cos = math.cos(angle);
    num sin = math.sin(angle);
    num oneMinusCos = 1.0 - cos;
    ...
    num n11 = nx * nx * oneMinusCos + cos;
    num n12 = nx * ny * oneMinusCos - nz * sin;
    num n13 = nx * nz * oneMinusCos + ny * sin;
    num n21 = ny * nx * oneMinusCos + nz * sin;
    num n22 = ny * ny * oneMinusCos + cos;
    num n23 = ny * nz * oneMinusCos - nx * sin;
    num n31 = nz * nx * oneMinusCos - ny * sin;
    num n32 = nz * ny * oneMinusCos + nx * sin;
    num n33 = nz * nz * oneMinusCos + cos;

    _data[00] = m00 * n11 + m01 * n21 + m02 * n31;
    _data[01] = m10 * n11 + m11 * n21 + m12 * n31;
    _data[02] = m20 * n11 + m21 * n21 + m22 * n31;
    _data[03] = m30 * n11 + m31 * n21 + m32 * n31;
    _data[04] = m00 * n12 + m01 * n22 + m02* n32;
    _data[05] = m10 * n12 + m11 * n22 + m12 * n32;
    _data[06] = m20 * n12 + m21 * n22 + m22 * n32;
    _data[07] = m30 * n12 + m31 * n22 + m32 * n32;
    _data[08] = m00 * n13 + m01 * n23 + m02 * n33;
    _data[09] = m10 * n13 + m11 * n23 + m12 * n33;
    _data[10] = m20 * n13 + m21 * n23 + m22 * n33;
    _data[11] = m30 * n13 + m31 * n23 + m32 * n33;
  }
  ...
  void copyFromMatrix2D(Matrix matrix) {
    _data[00] = matrix.a; _data[01] = matrix.c; _data[02] = 0.0; _data[03] =  matrix.tx;
    _data[04] = matrix.b; _data[05] = matrix.d; _data[06] = 0.0; _data[07] =  matrix.ty;
    _data[08] = 0.0; _data[09] = 0.0; _data[10] = 1.0; _data[11] = 0.0;
    _data[12] = 0.0; _data[13] = 0.0; _data[14] = 0.0; _data[15] = 1.0;
  }
