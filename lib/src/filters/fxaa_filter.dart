...
class FxaaFilterProgram extends RenderProgramSimple {
  ...
  String get fragmentShaderSource => """
    ...
    void main() {
      ...
      vec3 rgbA = 0.50 * (texture2D(uSampler, vTextCoordXY + dir * (0.33333 - 0.5)).xyz + texture2D(uSampler, vTextCoordXY + dir * (0.66666 - 0.5)).xyz);
      vec3 rgbB = 0.25 * (texture2D(uSampler, vTextCoordXY + dir * (0.00000 - 0.5)).xyz + texture2D(uSampler, vTextCoordXY + dir * (0.00000 + 0.5)).xyz) + rgbA * 0.5;
