...
class BlendMode {
  ...
  void blend(web.WebGLRenderingContext renderingContext) {
    renderingContext.blendFunc(srcFactor, dstFactor);
    renderingContext.blendEquation(web.WebGLRenderingContext.FUNC_ADD);
  }
  ...
  static const BlendMode NORMAL = BlendMode(web.WebGLRenderingContext.ONE,
      web.WebGLRenderingContext.ONE_MINUS_SRC_ALPHA, 'source-over');
  ...
  static const BlendMode ADD = BlendMode(
      web.WebGLRenderingContext.ONE, web.WebGLRenderingContext.ONE, 'lighter');
  ...
  static const BlendMode MULTIPLY = BlendMode(
      web.WebGLRenderingContext.DST_COLOR,
  ...
  /// the display object.
  static const BlendMode SCREEN = BlendMode(web.WebGLRenderingContext.ONE,
      web.WebGLRenderingContext.ONE_MINUS_SRC_COLOR, 'screen');

  /// Erases the background based on the alpha value of the display object.
  static const BlendMode ERASE = BlendMode(web.WebGLRenderingContext.ZERO,
      web.WebGLRenderingContext.ONE_MINUS_SRC_ALPHA, 'destination-out');
  ...
  static const BlendMode BELOW = BlendMode(
      web.WebGLRenderingContext.ONE_MINUS_DST_ALPHA,
      web.WebGLRenderingContext.ONE,
      'destination-over');
  ...
  static const BlendMode ABOVE = BlendMode(web.WebGLRenderingContext.DST_ALPHA,
      web.WebGLRenderingContext.ONE_MINUS_SRC_ALPHA, 'source-atop');
  ...
  /// pixels.
  static const BlendMode NONE = BlendMode(web.WebGLRenderingContext.ONE,
      web.WebGLRenderingContext.ZERO, 'source-over');
}
