...
class BlendMode {
  ...
  static const BlendMode NORMAL = const BlendMode(
      gl.WebGL.ONE, gl.WebGL.ONE_MINUS_SRC_ALPHA, "source-over");
  ...
  static const BlendMode MULTIPLY = const BlendMode(
      gl.WebGL.DST_COLOR, gl.WebGL.ONE_MINUS_SRC_ALPHA, "multiply");
  ...
  static const BlendMode ERASE = const BlendMode(
      gl.WebGL.ZERO, gl.WebGL.ONE_MINUS_SRC_ALPHA, "destination-out");
  ...
  static const BlendMode BELOW = const BlendMode(
      gl.WebGL.ONE_MINUS_DST_ALPHA, gl.WebGL.ONE, "destination-over");
  ...
  static const BlendMode ABOVE = const BlendMode(
