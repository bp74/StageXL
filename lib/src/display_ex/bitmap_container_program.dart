...
class _BitmapContainerProgram extends RenderProgram {
  ...
  void activate(RenderContextWebGL renderContext) {
    ...
    if (_contextIdentifier != renderContext.contextIdentifier) {
      ...
      _aPositionLocation = attribLocations["aPosition"];
      _aOffsetLocation = attribLocations["aOffset"];
      _aScaleLocation = attribLocations["aScale"];
      _aSkewLocation = attribLocations["aSkew"];
      _aTextCoordLocation = attribLocations["aTextCoord"];
      _aAlphaLocation = attribLocations["aAlpha"];
