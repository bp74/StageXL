...
void main() {
  test('new matrix', () {
    Matrix m = Matrix(0.269, 0.283, 0.313, 0.479, 0.659, 0.701);
  ...
  test('Matrix.concat', () {
    Matrix m = Matrix(0.269, 0.283, 0.313, 0.479, 0.659, 0.701);
    Matrix n = Matrix(0.569, 0.521, 0.829, 0.983, 0.241, 0.677);
    m.concat(n);
